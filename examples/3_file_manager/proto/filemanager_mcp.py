...
try:
    from . import filemanager_pb2
except ImportError:
    import filemanager_pb2
...
def _from_pb_read_file_request(message: filemanager_pb2.ReadFileRequest) -> ReadFileRequest:
    return ReadFileRequest(
        filename=message.filename,
    )

def _to_pb_read_file_request(value: ReadFileRequest) -> filemanager_pb2.ReadFileRequest:
    message = filemanager_pb2.ReadFileRequest()
    message.filename = value.filename
    return message

def _from_pb_read_file_response(message: filemanager_pb2.ReadFileResponse) -> ReadFileResponse:
    return ReadFileResponse(
        content=message.content,
    )

def _to_pb_read_file_response(value: ReadFileResponse) -> filemanager_pb2.ReadFileResponse:
    message = filemanager_pb2.ReadFileResponse()
    message.content = value.content
    return message

def _from_pb_delete_file_request(message: filemanager_pb2.DeleteFileRequest) -> DeleteFileRequest:
    return DeleteFileRequest(
        filename=message.filename,
    )

def _to_pb_delete_file_request(value: DeleteFileRequest) -> filemanager_pb2.DeleteFileRequest:
    message = filemanager_pb2.DeleteFileRequest()
    message.filename = value.filename
    return message

def _from_pb_delete_file_response(message: filemanager_pb2.DeleteFileResponse) -> DeleteFileResponse:
    return DeleteFileResponse(
        success=message.success,
    )

def _to_pb_delete_file_response(value: DeleteFileResponse) -> filemanager_pb2.DeleteFileResponse:
    message = filemanager_pb2.DeleteFileResponse()
    message.success = value.success
    return message

class FileManagerAPIToolHandler(Protocol):
    def read_file(self, ctx: ToolRequestContext, req: ReadFileRequest) -> ReadFileResponse | Awaitable[ReadFileResponse]:
        ...
    def delete_file(self, ctx: ToolRequestContext, req: DeleteFileRequest) -> DeleteFileResponse | Awaitable[DeleteFileResponse]:
        ...

def register_file_manager_api_tools(server: mcp.server.lowlevel.Server, impl: FileManagerAPIToolHandler, *, namespace: str | None = None) -> None:
    if impl is None:
        raise ValueError("register_file_manager_api_tools: impl is nil")
    registry = _install_server_handlers(server)
    resolved_namespace = _normalize_namespace(namespace, "files")
    registry.add_tool(_RegisteredTool(
        name=_tool_name(resolved_namespace, "ReadFile"),
        title="",
        description="Reads the content of a file.",
        input_schema_json=FILE_MANAGER_API_READ_FILE_INPUT_SCHEMA_JSON,
        output_schema_json=FILE_MANAGER_API_READ_FILE_OUTPUT_SCHEMA_JSON,
        request_type=filemanager_pb2.ReadFileRequest,
        response_type=filemanager_pb2.ReadFileResponse,
        from_pb=_from_pb_read_file_request,
        to_pb=_to_pb_read_file_response,
    ...
    registry.add_tool(_RegisteredTool(
        ...
        input_schema_json=FILE_MANAGER_API_DELETE_FILE_INPUT_SCHEMA_JSON,
        output_schema_json=FILE_MANAGER_API_DELETE_FILE_OUTPUT_SCHEMA_JSON,
        request_type=filemanager_pb2.DeleteFileRequest,
        response_type=filemanager_pb2.DeleteFileResponse,
        from_pb=_from_pb_delete_file_request,
        to_pb=_to_pb_delete_file_response,
...
FILE_MANAGER_API_READ_FILE_OUTPUT_SCHEMA_JSON = "{\"type\":\"object\",\"properties\":{\"content\":{\"type\":\"string\",\"examples\":[\"example\"]}},\"examples\":[{\"content\":\"example\"}],\"required\":[\"content\"],\"additionalProperties\":false}"

FILE_MANAGER_API_DELETE_FILE_INPUT_SCHEMA_JSON = "{\"type\":\"object\",\"properties\":{\"filename\":{\"type\":\"string\",\"description\":\"The name of the file to delete. Must not contain paths or directories.\",\"examples\":[\"example\"],\"minLength\":1,\"pattern\":\"^[a-zA-Z0-9_\\\\-\\\\.]+$\"}},\"examples\":[{\"filename\":\"example\"}],\"required\":[\"filename\"],\"additionalProperties\":false}"

FILE_MANAGER_API_DELETE_FILE_OUTPUT_SCHEMA_JSON = "{\"type\":\"object\",\"properties\":{\"success\":{\"type\":\"boolean\",\"examples\":[true]}},\"examples\":[{\"success\":true}],\"required\":[\"success\"],\"additionalProperties\":false}"
